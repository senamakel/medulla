...
configured sources. It is one of three independent stores Medulla keeps for you,
and none of them overwrites another:

| Store | Scope | Primary consumer |
| --- | --- | --- |
| Persona / `PERSONA.md` | User-level learned context | Prompt construction, [Memory](memory.md) |
