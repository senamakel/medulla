...
pub(super) use super::super::routing_options::{ROUTING_STRATEGIES, SUBSCRIPTION_STRATEGIES};
...
pub struct App {
    ...
    pub(super) changes: super::super::changes::GitChangesState,
    pub(super) draft: Draft,
    ...
    pub(super) graph: super::super::render::graph::Graph,
    ...
    pub(super) agent_anchor: Option<super::super::rail::RailAnchor>,
    ...
    #[cfg(feature = "workflows")]
    pub(super) live_runs: std::collections::HashMap<String, super::super::workflows::LiveRun>,
